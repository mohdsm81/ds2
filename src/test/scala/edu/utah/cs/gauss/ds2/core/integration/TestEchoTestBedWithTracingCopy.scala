 ...
 */
//@Ignore
class TestEchoTestBedWithTracingCopy extends MyTestSpecs {

  info("""=======================================================""")
  info("""Copy-link and scheduler-snapshot+link tests - The same 
    TestBed with sends but with Tracing enabled""")
  info("""=======================================================""")

  val myDS = TestBeds.echoServerInstanceWithTracingCopy
